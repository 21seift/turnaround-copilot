...
The instrument used for the expert appraisal is in
[`docs/Expert_Appraisal_Survey.html`](docs/Expert_Appraisal_Survey.html)
(open in a browser). It is also hosted at
https://tranquil-cheesecake-d01e34.netlify.app/ and generated by
`turnaround_sim/export_appraisal.py`. Returned responses are in
[`docs/appraisal_responses/`](docs/appraisal_responses/):

```bash
python -m turnaround_sim.tally_appraisal docs/appraisal_responses
```

## Written deliverables

Accompanying submission files are in [`docs/`](docs/):

- [`docs/MSc_Project_Proposal.pdf`](docs/MSc_Project_Proposal.pdf) — project proposal
- [`docs/MSc_MidPoint_Review.pdf`](docs/MSc_MidPoint_Review.pdf) — midpoint review
- [`docs/MSc_Project_Gantt.pdf`](docs/MSc_Project_Gantt.pdf) — project plan / Gantt chart
- [`docs/Expert_Appraisal_Survey.html`](docs/Expert_Appraisal_Survey.html) — expert appraisal instrument
- [`docs/appraisal_responses/`](docs/appraisal_responses/) — returned appraisal CSVs

The full capstone report will be added here when finalised.
