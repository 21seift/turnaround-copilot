...
Accompanying submission PDFs are in [`docs/`](docs/):

- [`docs/MSc_Capstone_Project_Report.pdf`](docs/MSc_Capstone_Project_Report.pdf) — full project report
...
not certified for use in live ground handling. The full report is in
[`docs/MSc_Capstone_Project_Report.pdf`](docs/MSc_Capstone_Project_Report.pdf).
